    ...
    return (
        <div className='mt-52 bg-[#FEF5F5]'>
           <div className=' mx-52'>
                ...
                <div className="grid grid-cols-3 gap-12 pb-32 relative">
                    <div className="card-style">
                        <div className="card bg-white w-[300px] h-[260px] flex items-center py-12 text-center z-10">
